...
title = """<h1 align="center">MiniMedGPT Demo</h1>"""
description = 'Welcome to Our MiniMedGPT Chatbot Demo!'
...
introduction = 'Upload you medical image'
# '''
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column(scale=0.5):
            image = gr.Image(type="pil")# ###CHANGED , tool='sketch', brush_radius=20)
        ...
        with gr.Column():
            ...
            chatbot = gr.Chatbot(label='MiniMedGPT')
...
demo.launch(share=True)# ###CHANGED, enable_queue=True)
